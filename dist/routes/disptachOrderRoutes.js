...
function dispatchOrderRouter(dbHandler) {
    ...
    router.put("/update/:DO_number", async (req, res) => {
        ...
        try {
            ...
            const result = await dbHandler.updateDispatchOrder(DO_num, updatedDispatchOrder);
...
exports.dispatchOrderRouter = dispatchOrderRouter;
//# sourceMappingURL=disptachOrderRoutes.js.map